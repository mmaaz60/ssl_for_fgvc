import torch
from ssl_pretraining.test.base_tester import BaseTester
import logging
from ssl_pretraining.rotation.ssl_utils import preprocess_input_data
...
class SSLrotTrainer:
    def __init__(self, model, dataloader, class_loss_function, rot_loss_function, optimizer, epochs,
        ...
        self.validator = BaseTester(val_dataloader, class_loss_function, rot_loss_function, model) if val_dataloader else None
        self.metrics = {}
